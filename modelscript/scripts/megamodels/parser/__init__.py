...
from modelscript.base.issues import (
    Issue,
    Levels)
from modelscript.base.symbols import (
    Symbol)
from modelscript.megamodels.dependencies.sources import SourceImport
from modelscript.megamodels.metamodels import (
    Metamodel)
from modelscript.scripts.megamodels.parser.statements import (
    ImportStatement,
    DefinitionStatement)
...
def getModelDefinitionStatement(modelSourceFile, astModelDefinition):
    ...
    Model definition looks like this
        ...
        class model MyModel
    """
    from modelscript.base.grammars import ASTNodeSourceIssue
