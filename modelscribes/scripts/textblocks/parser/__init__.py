...
after parsing it contains the model, a TextBlockModel.
"""
...
from modelscribes.scripts.textblocks.parser.segments import (
    segmentsAndErrors,
    Segment,
    StringSegment,
    ReferenceSegment,
