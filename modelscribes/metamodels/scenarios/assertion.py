...
#TODO: split parsing (e.g. _extractAssertionsFromFile) and metamodel (InvariantAssertionEvaluation)
#TODO: -> @assert inv C1::XXX -> true
#TODO: -> @assert inv C1::XXX -> false
#TODO: -> @assert inv C1::* -> false
#TODO: -> @assert inv XXX -> true   # ambuiguous
#TODO: -> @assert inv * -> true

#TODO: @assert query <expr> -> <expr>
